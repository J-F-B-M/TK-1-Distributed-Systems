...
public class Display extends JFrame {
	...
	// This lock protects the array flyPosition because I'm not entirely sure
	// whether Swing can interfere. Safe is safe.
	Lock						lock;
	int[]						flyPosition;
	Image						img;

	// To notify the client of events, could have also been solved by an
	// event-queue, but this is faster.
	Client						client;
	...
	private Component generateMainPane() {
		JPanel drawingCanvas = new JPanel() {
			...
			public void paintComponent(Graphics g) {
				...
				// setting to white because someone didn't supplied a picture
	...
	public void updateTable(Object[][] dataVector) {
		/*
		 * Yes, this is a convenience method. I want to keep track of the
		 * playerlist only at one place, and that is not here. This class
		 * *should* only show stuff, so I simply update the TableModels contents
		 * every time I change something. I mean, this is definitly NOT task of
